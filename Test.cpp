...
TEST_CASE("Good input") {
	...
	//column + s.length>100 but  its vertical so its ok
	s = "hello";
	notebook.write(/*page=*/6, /*row=*/100, /*column=*/96, Direction::Vertical, s);
	CHECK(notebook.read(/*page=*/6, /*row=*/100, /*column=*/96, Direction::Vertical, /*length=*/s.length()) == (s));
	notebook.erase(/*page=*/6, /*row=*/100, /*column=*/96, Direction::Vertical, /*length=*/s.length());
	CHECK(notebook.read(/*page=*/6, /*row=*/100, /*column=*/96, Direction::Vertical, /*length=*/s.length()) == ("~~~~~"));
	//double erase
	notebook.erase(/*page=*/6, /*row=*/100, /*column=*/96, Direction::Vertical, /*length=*/s.length());
	CHECK(notebook.read(/*page=*/6, /*row=*/100, /*column=*/96, Direction::Vertical, /*length=*/s.length()) == ("~~~~~"));
...
TEST_CASE("Bad input-more then 100 char") {
	...
	//column + s.length>100 + horizontal
...
TEST_CASE("Bad input-erase in a place that is not empty") {
	ariel::Notebook notebook;
    string s = "hello";
	//horizontal
